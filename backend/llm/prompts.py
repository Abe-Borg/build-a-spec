...
- A source_ref must name something this section actually holds: a finding in the research profile (r-…), an attached document (ref-…), or a finding of the retained Final QC review. For a fact the user stated or that you proposed, leave source_ref empty and say who stated it, and when, in detail. A ref that names nothing is refused — correct it or drop it; never guess an id.
