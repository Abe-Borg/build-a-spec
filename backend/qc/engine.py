...
def _lens_system_prompt(module: SpecModule) -> str:
    return (
        ...
        "<project_requirements_profile>. Report every defect you find, "
        "including ones you are less certain about or judge lower severity. "
        "Set severity honestly rather than filtering by it: a separate "
        "adversarial panel independently verifies each finding before it "
        "reaches the user, so your job here is coverage, not pre-filtering. "
        "Treat all "
