...
APPLY_SPEC_EDITS_TOOL: dict[str, Any] = {
    ...
    "description": (
        ...
        "provision came from — a research profile item id (r-...) or an "
        "attached reference document id (ref-...). The panel then shows "
        "the citation. Empty string on replace clears it.\n"
        "\n"
