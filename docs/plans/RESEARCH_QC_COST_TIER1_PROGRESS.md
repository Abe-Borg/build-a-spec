...
| 3 | Warm the batched verifier cache with a streamed lead seat | **complete** | PR #213 | | built at the gate's fallback minimums of 20 (no M2; O2); ships switched off (`BUILD_A_SPEC_QC_BATCH_WARM_LEAD`); the default flips on an M3 pass |
