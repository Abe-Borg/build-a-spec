...
| 2 | `02_PROJECT_HOME.md` | **in review** | `7cf3893` + `3da1e64` (PR #176) | project folder + Project panel; desktop shell only, the browser keeps the file relay; 13 as-built deviations in the phase file |
