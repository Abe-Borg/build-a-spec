...
| 4 | `04_HARVEST.md` | **in review** | `54d2437` + `9b8b40d` (PR #185) | the fact harvest: one opt-in paid call, a review sheet, one-batch commit; a fact's source must resolve (the recording tool, the panel, the commit), older ones flagged, never rewritten; a reply source pinned to the reply it cited; 25 as-built deviations in the phase file (23 as built + 2 from the Codex review) |
