...
export default function IssuesDrawer({
  ...
  return (
    <div
      className="border-t border-edge bg-bg/60 px-5 py-2"
    ...
    >
      <button
        ...
        aria-controls="lint-issues-list"
        title="Advisory lint issues"
      >
      ...
      {expanded && (
        <ul
          id="lint-issues-list"
          className="mt-1.5 max-h-36 space-y-1 overflow-y-auto"
        >
          {issues.map((issue) => (
            <li key={issue.id}>
              <button
