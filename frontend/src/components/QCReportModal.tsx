      ...
      >
        ...
        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto px-4 py-4 sm:px-6">
          ...
          <Section
            ...
            description="Counts are derived from the full result, keeping surviving, disputed, substantively refuted, and infrastructure-inconclusive candidates distinct. Unknown values are never folded into “low” or dropped."
          >
